...
static void SDRAM_ForceApolloConfig(void)
{
  ...
  MODIFY_REG(FMC_Bank5_6->SDCR[0], FMC_SDCR1_NC, FMC_SDRAM_COLUMN_BITS_NUM_9);
}

static void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdram)
{
  FMC_SDRAM_CommandTypeDef command = {0};
  uint32_t modeRegister = 0U;
  ...
  modeRegister = SDRAM_MODEREG_BURST_LENGTH_1 |
  ...
  if (HAL_SDRAM_ProgramRefreshRate(hsdram, 1386U) != HAL_OK)
  {
    Error_Handler();
  }
}
